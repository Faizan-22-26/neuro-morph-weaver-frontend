...
} from "./chunk-N7VXLQEH.js";
import {
  EffectWrapper
} from "./chunk-GA5NGZ2O.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-WF7AD6WK.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-J4JW3GCQ.js");
    const textures = [];
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      ...
      await import("./lod.fragment-4C2O7ZMC.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-PRRGAED7.js");
    } else {
      await import("./lod.fragment-3N6CF4EQ.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-2VM2O7KG.js.map
