...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-B3XKZAGH.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-MUXJMDWK.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-ZGVMJRPA.js.map
